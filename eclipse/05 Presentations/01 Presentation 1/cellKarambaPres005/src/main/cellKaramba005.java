...
//	CAMERA
	...
	public void setup() {
		...
		if (defaultCam == true) {
			...
			cam = new PeasyCam( this, -172.09892 , -9.656972 , 3.7445881, 100 ); // saved view
			cam.setRotations( 0.34580228 , -1.4074552 , -2.8885407 ); // saved view
			cam.setDistance( 164.37101839892273 );
			cam.lookAt( -9.9157715 , -0.5970292 , -21.402454 );
		}
