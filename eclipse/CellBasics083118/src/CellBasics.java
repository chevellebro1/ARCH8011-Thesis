...
public class CellBasics extends PApplet{
	...
	double _range = 5.0;// range to search for neighbors
	double _rangeClose = 1.0;// range to define close neighbors.do not change
	double _drag = 0.5;// drag coefficient (0.5)
	double _facNeighborsClose = -0.7;// attraction/repulsion to close neighbors
	double _facNeighborsClosest = -0.15;// attraction/repulsion to closest neighbor
	double _facNeighborsFar = 0.0;// attraction/repulsion to far neighbors
	double _facPlanarize = 0.2;// planarity force (0.2)
	double _facStrata = 0.0;// strata force (0.03-0.04)
	double _facOrthogonal = 0.0;// orthogonal force (0.05)
	double _facAttractors = 0.0;// force towards attractors (0.05)
	Vec3D _unary = new Vec3D(0.0, 0.0, 0.005);// unary force (-0.005)
	double _facFollowMesh = 0.01;// force towards meshes (+/-0.01-0.05)
	double _facVoxel = 0.0;// force towards the closest voxel
	...
	double _rangeDivide = 3.5;// maximum average distance after which the division is triggered
	double _offsetDivision = 0.1;// random offset of the child cell from the parent cell (0.1)
	double _facVelChild = 0.0;// scale factor for child velocity after cell division (a negative value inhibits the growth of tentacles)
	double _facVelParent = -1.0;// scale factor for parent velocity after cell division (a negative value inhibits the growth of tentacles)
