...
public class Attractor extends Vec3D {
	...
	// VARIABLES
	  ...
	  public void display(){
	    ...
	    parent.stroke(col[0],col[1],col[2],25);
	    for(int i=0;i<7;i++){
	      parent.strokeWeight((i*2)+1);
	      if(activeDir[0]==true && activeDir[1]==true && activeDir[2]==true){
	    	  parent.point(x, y, z);
	      }else if(activeDir[0]==false){
	    	  parent.line(x+100,y,z,x-100,y,z);
	      }else if(activeDir[1]==false){
	    	  parent.line(x,y+100,z,x,y-100,z);
	      }else if(activeDir[2]==false){
	    	  parent.line(x,y,z+100,x,y,z-100);
	      }
	    }
	  }
