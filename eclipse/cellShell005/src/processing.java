...
class Attractor extends Vec3D{
  ...
  // CONSTRUCTOR
  Attractor(Vec3D _pos, float _strength) { // POINT
    super(_pos);
    strength = _strength;
  ...
  Attractor(Vec3D _pos, float _strength, float _radius) { //POINT RADIUS
    super(_pos);
    strength = _strength;
    radius = _radius;
    if (strength>0) col = new int[] {0,255,100};
  ...
  Attractor(Vec3D _pos, float _strength, float _radius, int _exponent) { //POINT RADIUS EXPONENT
    super(_pos);
    strength = _strength;
    radius = _radius;
    exponent = _exponent;
  ...
  Attractor(Vec3D _pos, float _strength, boolean[] _activeDir) { //LINE 
    super(_pos);
    strength = _strength;
  ...
  Attractor(Vec3D _pos, float _strength, float _radius, boolean[] _activeDir) { //LINE RADIUS
    super(_pos);
    strength = _strength;
    radius = _radius;
    activeDir = _activeDir;
  ...
  Attractor(Vec3D _pos, float _strength, float _radius, int _exponent, boolean[] _activeDir) { //LINE RADIUS EXPONENT
    super(_pos);
    strength = _strength;
    radius = _radius;
    exponent = _exponent;
